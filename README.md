...
- Browser APIs and modern JavaScript
- Functional programming patterns

### Run Locally
```bash
git clone https://github.com/carnocentaurus/AllInOnePortfolio
cd AllInOnePortfolio
open index.html
```
...
| Slot Machine | Casino-style simulator with betting system |
...
- Profile customization with image storage
...
- Zero dependencies for faster load times
